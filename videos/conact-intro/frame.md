...
description: >
  ...
  identical and sacred — the five-tone warm-stone palette, Playfair Display 400 + Inter + IBM Plex Mono, the
...
colors:
  ...
  accent: "#9A8A72"
  line: "#C8BFA8"
  white-overlay: "rgba(253,251,246,0.55)"
  # — semantic pair: the film's only saturated colors, and the whole color story —
  approve: "#5A8A5A"
  approve-bg: "#E6EEE3"
  reject: "#A85440"
  reject-bg: "#F5E4E0"
...
typography:
  ...
  label:       { fontFamily: "IBM Plex Mono", px: 14, weight: 400, tracking: "3px", upper: true, color: "accent" }
  attribution: { fontFamily: "IBM Plex Mono", px: 15, weight: 400, tracking: "2px", upper: true, color: "accent" }
  micro:       { fontFamily: "IBM Plex Mono", px: 12, weight: 400, tracking: "2px", upper: true, color: "accent" }
  # — data ramp (IBM Plex Mono) — every number, hash, address, and contract signature —
  mono:        { fontFamily: "IBM Plex Mono", cqw: 1.0, weight: 400, lineHeight: 1.5, color: "text-secondary" }
  mono-lg:     { fontFamily: "IBM Plex Mono", cqw: 1.6, weight: 400, lineHeight: 1.4, color: "text-primary" }
  code:        { fontFamily: "IBM Plex Mono", cqw: 1.15, weight: 400, lineHeight: 1.5, color: "text-primary" }
